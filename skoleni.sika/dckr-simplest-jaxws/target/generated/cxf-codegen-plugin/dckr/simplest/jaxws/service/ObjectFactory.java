 ...
 * generated in the dckr.simplest.jaxws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloRequest_QNAME = new QName("http://service.jaxws.simplest.dckr", "HelloRequest");
    private final static QName _HelloResponse_QNAME = new QName("http://service.jaxws.simplest.dckr", "HelloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dckr.simplest.jaxws.service
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://service.jaxws.simplest.dckr", name = "HelloRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://service.jaxws.simplest.dckr", name = "HelloResponse")
